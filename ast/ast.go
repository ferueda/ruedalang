...
// An ExpressionStatement node represents an expression.
...
// A PrefixExpression node represents a Prefix expression.
...
// A InfixExpression node represents a infix (binary) expression.
