...
// NewParser returns a pointer to a new parser struct value.
...
// peekPrecedence method returns the precedence associated with the
// token type of p.peekToken.
...
// curPrecedence method returns the precedence associated with the
// token type of p.curToken.
